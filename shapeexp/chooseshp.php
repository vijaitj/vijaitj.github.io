...
<head>
    ...
    <link rel="stylesheet" href="skins/normalize.min.css" type="text/css">
...
for($k = 0; $k < 2; $k++)
{
	...
	for($u_cnt = 0;$u_cnt < 3; $u_cnt++)
	{
		...
		echo "</span>";
		echo "<span class='sidenav-link-title'>User ".$mn_usr_dsp[$u_cnt]."</span>";
...
<header>
  <a href="javascript:;" class="toggle" id="sidenav-toggle">
    ...
    for ($cnt = 1; $cnt <= 18; $cnt++) 
    {
		...
		//echo $elmz[0];
		echo "<li>";
		echo "<a class='rig-cell' href='view.php?user=".$usr."&case=".$case."&set=".$set."&shape=".$cnt."'>";
